...
OUTPUT_DIR="batch_outputs_cutoff_3.0"
...
echo "Starting batch alignment process with cutoff 3.0..."
...
while read -r PDB1 PDB2; do
    ...
    COMMAND="KMP_DUPLICATE_LIB_OK=True python3 gemini_tm_align_cutoff_3.0.py --mobile \"$MOBILE_PDB\" --reference \"$REFERENCE_PDB\" --steps 5000 --output \"$OUTPUT_PDB\""
